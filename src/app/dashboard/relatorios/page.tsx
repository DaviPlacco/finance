      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
        <div className="glass-card p-5 sm:p-8">
          <div className="flex items-center gap-3 sm:gap-4 mb-6">
            ...
            <h2 className="text-lg sm:text-xl font-bold text-slate-900 dark:text-white">Selecionar Período</h2>
          </div>
          ...
          <div className="space-y-5 sm:space-y-6">
            ...
            <button 
              ...
              className="w-full flex items-center justify-center gap-2 py-3.5 sm:py-4 bg-primary text-white font-bold rounded-xl shadow-lg shadow-primary/30 hover:bg-primary/90 transition-all disabled:opacity-70 text-sm sm:text-base"
            >
              {isGenerating ? (
                <>A gerar documento...</>
              ) : (
        ...
        <div className="glass-card p-5 sm:p-8">
          <div className="flex items-center gap-3 sm:gap-4 mb-6">
            <div className="p-2.5 sm:p-3 bg-slate-100 dark:bg-slate-800 rounded-xl">
              <FileText className="w-5 h-5 sm:w-6 sm:h-6 text-slate-600 dark:text-slate-300" />
            </div>
            <h2 className="text-lg sm:text-xl font-bold text-slate-900 dark:text-white">O que inclui o relatório?</h2>
          </div>
